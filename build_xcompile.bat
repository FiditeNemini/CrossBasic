...
windres ./XCompiler/xcompile.rc -O coff -o ./XCompiler/xcompile.res
if %ERRORLEVEL% NEQ 0 (
...
g++ -s -static -m64 -o xcompile.exe ./XCompiler/xcompile.cpp ./XCompiler/xcompile.res -static-libgcc -static-libstdc++ -O3 -march=native -mtune=native 2> error.log
