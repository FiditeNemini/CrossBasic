/*
  ...
  CrossBasic Plugin: LLMConnectionClass                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      4r
  ...
  Build (Linux/macOS):    g++ -shared -fPIC -o LLMConnectionPlugin.so LLMConnectionClass.cpp -lcurl
  Build (Windows):        g++ -shared -o LLMConnectionPlugin.dll LLMConnectionClass.cpp -static -lcurl -lcurl.dll
