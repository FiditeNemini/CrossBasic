/*
  ...
  CrossBasicFramework.cpp
  CrossBasic Plugin: CrossBasicFramework
  ...
  Build (macOS/Linux): g++ -shared -fPIC -o CrossBasicFramework.dylib/so CrossBasicFramework.cpp
  Build (Windows):     g++ -shared -o CrossBasicFramework.dll CrossBasicFramework.cpp
...
extern "C" XPLUGIN_API void XMessageBox(const char* text) {
    #ifdef _WIN32
        ::MessageBoxA(NULL,
                      text ? text : "",
                      "Message",
    ...
    #else
        std::cout << "MessageBox: " << (text ? text : "") << std::endl;
    #endif
    }
...
static PluginEntry pluginEntries[] = {
    ...
    {"Format", (void*)Format, 2, {"double", "string"}, "string"},
    ...
    {"MessageBox", (void*)XMessageBox, 1, {"string"}, "void"}
};
