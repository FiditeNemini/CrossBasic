/*
  ...
  DateTimePlugin.cpp
  CrossBasic Plugin: DateTimePlugin                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      4r
...
*/ 
// Build: g++ -shared -o DateTimePlugin.dll DateTimePlugin.cpp (Windows)
//        g++ -shared -fPIC -o DateTimePlugin.dylib/so DateTimePlugin.cpp (MacOS/Linux)
